...
public class ExceptionCommandHandler {
    public static Response handleExceptions(String inputString, ObjectOutputStream out, UserCredentials credentials) {
        try {
            ...
            return new Response(1, TextColor.red("Произошла фатальная ошибка считывания " +
                    "команд из файла"));
            ...
            return new Response(1, TextColor.yellow(TextColor.yellow("Введенный индекс выходит" +
